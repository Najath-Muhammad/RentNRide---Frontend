...
import { searchLocations, reverseGeocode } from '../services/location.service'; // adjust path
...
const Navbar = () => {
  ...
  const handleSuggestionClick = (suggestion: string) => {
    ...
    // Optional: here you could also store lat/lon if needed later
    // (you would need to fetch them via search again or modify service)
  };
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center gap-5">
            {isAuthenticated && user ? (
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="relative group">
                    ...
                    <div className="absolute right-0 mt-4 w-72 bg-white rounded-2xl shadow-lg border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform origin-top-right z-50">
                      {/* ... your existing profile menu content ... */}
                      <div className="p-2">
                        ...
                        {/* Profile, My Vehicles, My Bookings, etc. */}
              ...
              // Not authenticated – login/signup buttons (your original code)
              // ...
            )}
          </div>
        </div>
